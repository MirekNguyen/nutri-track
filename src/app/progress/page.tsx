                  ...
                  <Card>
                    ...
                    <CardContent className="h-80 flex items-center justify-center">
                      {isLoading ? (
                          ...
                          <div className="flex flex-col h-full">
                            <div className="flex-1 relative">
                              {weightEntries
                                ...
                                .reverse()
                                .map((entry, index, arr) => {
                                  const minWeight = Math.min(...arr.map((e) => Number(e.weight)))
                                  const maxWeight = Math.max(...arr.map((e) => Number(e.weight)))
                                  const range = maxWeight - minWeight || 10
                                  const height = ((Number(entry.weight) - minWeight) / range) * 80 + 10
                                  ...
                                  return (
                                    ...
                                    >
                                      ...
                                      {index === 0 || index === arr.length - 1 ? (
                                        <div className="text-xs font-medium mt-1">{entry.weight}</div>
                                      ) : null}
                                    </div>
                                  )
                                })}
                              {weightEntries
                                ...
                                .map((entry, index, arr) => {
                                  ...
                                  const startHeight = ((Number(prev.weight) - minWeight) / range) * 80 + 10
                                  const endHeight = ((Number(entry.weight) - minWeight) / range) * 80 + 10
                                ...
                                .map((entry, index, arr) => (
                                  <div
                                    ...
                                    style={{
                                      ...
                                      display:
                                        arr.length > 7 && index % 2 !== 0 && index !== arr.length - 1
                                          ? "none"
                                          : "block",
                                    }}
                                  >
                        ...
                        <p className="text-gray-500">No weight entries yet. Add your first entry!</p>
                      )}
                    </CardContent>
                  </Card>
                </div>
                <div>
                  <Card>
                    <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                      <CardTitle className="text-sm font-medium">Weight Log</CardTitle>
                      <Dialog>
                      ...
                      <DialogContent>
                        ...
                        <DialogFooter>
                          <Button
                            ...
                            disabled={isSubmitting || (!newChest && !newWaist && !newHips && !newArms && !newThighs)}
                          >
                            {isSubmitting ? (
                              <>
                                <Loader2 className="mr-2 h-4 w-4 animate-spin" />
                ...
                <CardContent>
                  {isLoading ? (
                      ...
                      <table className="w-full">
                        <thead>
                          <tr className="border-b">
                            ...
                            <th className="text-center py-2 px-4 font-medium text-gray-500">Chest</th>
                            <th className="text-center py-2 px-4 font-medium text-gray-500">Waist</th>
                            <th className="text-center py-2 px-4 font-medium text-gray-500">Hips</th>
                            <th className="text-center py-2 px-4 font-medium text-gray-500">Arms</th>
                            <th className="text-center py-2 px-4 font-medium text-gray-500">Thighs</th>
                            <th className="text-center py-2 px-4 font-medium text-gray-500">Actions</th>
                          </tr>
                        </thead>
                        <tbody>
                          {measurements.map((measurement) => (
                            <tr key={measurement.id} className="border-b last:border-0">
                              <td className="py-3 px-4 font-medium">
                                {format(new Date(measurement.entryDate), "MMM d, yyyy")}
                              </td>
                              ...
                              <td className="py-3 px-4 text-center">
                                {measurement.thighs ? `${measurement.thighs}"` : "-"}
                              </td>
                              <td className="py-3 px-4 text-center">
                                <Button
                                  variant="ghost"
                    ...
                    <div className="text-center py-8 text-gray-500">
                      ...
                      <p className="text-sm mt-1">Add your first measurement to start tracking your progress</p>
                    </div>
                  )}
                </CardContent>
              </Card>
              ...
              <Card>
                ...
                <CardFooter className="border-t pt-6">
                  <p className="text-sm text-gray-500">
                    Tip: Take photos in the same lighting, position, and clothing for the most accurate comparison.
                  </p>
                </CardFooter>
              </Card>
            </TabsContent>
