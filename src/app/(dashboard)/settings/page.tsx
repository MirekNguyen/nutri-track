...
export default function SettingsPage() {
  ...
  // Inside the SettingsPage component, add:
            ...
            <TabsContent value="notifications" className="mt-6">
              <Card>
                ...
                <CardContent className="space-y-6">
                  <div className="space-y-4">
                    ...
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-sm text-gray-500">Receive reminders to log your meals</p>
                      </div>
                    ...
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-sm text-gray-500">Get notified about your progress towards goals</p>
                      </div>
                    ...
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-sm text-gray-500">Receive a weekly summary of your nutrition</p>
                      </div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-sm text-gray-500">Receive our nutrition and fitness newsletter</p>
                      </div>
                  ...
                  <div className="space-y-4">
                    <h3 className="text-sm font-medium text-gray-500">Reminder Times</h3>
                    <div className="space-y-2">
                      <Label htmlFor="breakfast-reminder" className="font-medium">
                        Breakfast Reminder
                      </Label>
                      <Input type="time" id="breakfast-reminder" defaultValue="08:00" />
                    </div>
                    <div className="space-y-2">
                    ...
                    <div className="space-y-2">
                      ...
                      <Input type="time" id="dinner-reminder" defaultValue="18:30" />
                    </div>
                  </div>
                </CardContent>
                <CardFooter>
                ...
                <CardContent className="space-y-6">
                  <div className="space-y-4">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4">
                      <Input defaultValue="john.doe@example.com" className="flex-1" />
            ...
            <TabsContent value="data" className="mt-6">
              <Card>
                ...
                <CardContent className="space-y-6">
                    ...
                    <div className="space-y-2">
                      <div className="flex items-center justify-between">
                        <div>
                          ...
                          <p className="text-sm text-gray-500">Keep a copy of your data on this device</p>
                        </div>
                      ...
                      <div className="flex items-center justify-between">
                        <div>
                          ...
                          <p className="text-sm text-gray-500">Automatically backup your data to the cloud</p>
                        </div>
                  ...
                  <div className="space-y-4">
                    <h3 className="text-sm font-medium text-gray-500">Data Usage</h3>
                    <div className="space-y-2">
                      <div className="flex items-center justify-between">
                        <div>
                      ...
                      <div className="flex items-center justify-between">
                        <div>
                          ...
                          <p className="text-sm text-gray-500">Allow us to personalize your experience</p>
                        </div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="space-y-4">
                      <div>
                        ...
                        <p className="text-sm text-gray-500 mb-2">Download all your nutrition and fitness data</p>
                        <Button variant="outline">Export Data</Button>
                      </div>
                      <div>
                        <p className="font-medium">Delete Your Data</p>
                        <p className="text-sm text-gray-500 mb-2">Permanently delete all your data</p>
