...
export default function WeightLossPage() {
  ...
  const calculateTimeToGoal = () => {
    ...
    const weightDifference = Number.parseFloat(currentWeight) - Number.parseFloat(targetWeight)
    const weeklyGoalLbs = Number.parseFloat(weeklyGoal)
      ...
      <div className="flex flex-col md:flex-row flex-1">
        ...
        >
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-6 gap-4">
            <h1 className="text-2xl md:text-3xl font-bold text-gray-800 dark:text-gray-100">Weight Loss Calculator</h1>
          </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <Card className="border-2 border-blue-200 dark:border-blue-700 bg-gradient-to-br from-blue-50 to-blue-100 dark:from-blue-900/30 dark:to-blue-800/30">
                  <CardHeader className="border-b-2 border-blue-200 dark:border-blue-700">
                    ...
                    <CardDescription>Calculate your daily calorie needs for weight loss</CardDescription>
                  </CardHeader>
                  <CardContent className="space-y-4 pt-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div>
                        <Label htmlFor="weeklyGoal">Weekly Weight Loss Goal (lbs)</Label>
                        <Select value={weeklyGoal} onValueChange={setWeeklyGoal}>
                          ...
                          <SelectContent>
                            ...
                            <SelectItem value="2">2 lbs/week (Very Fast)</SelectItem>
                          </SelectContent>
                        </Select>
                      </div>
                      <div>
                ...
                <Card className="border-2 border-green-200 dark:border-green-700 bg-gradient-to-br from-green-50 to-green-100 dark:from-green-900/30 dark:to-green-800/30">
                  <CardHeader className="border-b-2 border-green-200 dark:border-green-700">
                    ...
                    <CardDescription>Personalized recommendations for your weight loss journey</CardDescription>
                  </CardHeader>
                  <CardContent className="space-y-6 pt-6">
                    <div className="grid grid-cols-1 gap-4">
                      <div className="bg-white dark:bg-gray-800 p-4 rounded-lg border-2 border-green-300 dark:border-green-600">
                        <div className="text-sm text-gray-600 dark:text-gray-400">Daily Calorie Target</div>
                      ...
                      <div className="bg-white dark:bg-gray-800 p-4 rounded-lg border-2 border-green-300 dark:border-green-600">
                        <div className="text-sm text-gray-600 dark:text-gray-400">Daily Calorie Deficit</div>
                      ...
                      <div className="bg-white dark:bg-gray-800 p-4 rounded-lg border-2 border-green-300 dark:border-green-600">
                        <div className="text-sm text-gray-600 dark:text-gray-400">Time to Reach Goal</div>
                        <div className="text-2xl font-bold text-blue-600 dark:text-blue-400">{timeToGoal} weeks</div>
                      </div>

                      <div className="bg-white dark:bg-gray-800 p-4 rounded-lg border-2 border-green-300 dark:border-green-600">
                        <div className="text-sm text-gray-600 dark:text-gray-400">Total Weight to Lose</div>
                        <div className="text-2xl font-bold text-purple-600 dark:text-purple-400">
                          {currentWeight && targetWeight
                            ? (Number.parseFloat(currentWeight) - Number.parseFloat(targetWeight)).toFixed(1)
                            : 0}{" "}
                          lbs
                        </div>
                      </div>
                    ...
                    {recommendedCalories < 1200 && (
                      <div className="bg-red-50 dark:bg-red-900/30 border-2 border-red-200 dark:border-red-700 p-4 rounded-lg">
                        <div className="text-sm text-red-600 dark:text-red-400 font-medium">
                          ⚠️ Warning: Your calculated calorie target is very low. Consider a more moderate weight loss
                          goal or consult a healthcare professional.
                        </div>
                      </div>
                    )}
                  </CardContent>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <Card className="border-2 border-purple-200 dark:border-purple-700 bg-gradient-to-br from-purple-50 to-purple-100 dark:from-purple-900/30 dark:to-purple-800/30">
                  <CardHeader className="border-b-2 border-purple-200 dark:border-purple-700">
                    ...
                    <CardDescription>Your weight loss journey so far</CardDescription>
                  </CardHeader>
                  <CardContent className="pt-6">
                    {progress ? (
                      <div className="space-y-4">
                        <div className="bg-white dark:bg-gray-800 p-4 rounded-lg border-2 border-purple-300 dark:border-purple-600">
                          <div className="text-sm text-gray-600 dark:text-gray-400">Total Weight Lost</div>
                      ...
                      <div className="text-center py-8 text-gray-500">
                        ...
                        <p className="text-sm mt-2">Add more weight entries to see your progress!</p>
                      </div>
                    )}
                  </CardContent>
                </Card>
                ...
                <Card className="border-2 border-orange-200 dark:border-orange-700 bg-gradient-to-br from-orange-50 to-orange-100 dark:from-orange-900/30 dark:to-orange-800/30">
                  <CardHeader className="border-b-2 border-orange-200 dark:border-orange-700">
                    ...
                    <CardDescription>Your recent calorie intake analysis</CardDescription>
                  </CardHeader>
                  <CardContent className="pt-6">
                    <div className="space-y-4">
                      <div className="bg-white dark:bg-gray-800 p-4 rounded-lg border-2 border-orange-300 dark:border-orange-600">
                        <div className="text-sm text-gray-600 dark:text-gray-400">Average Daily Calories</div>
            ...
            <TabsContent value="insights" className="mt-6">
              <Card className="border-2 border-indigo-200 dark:border-indigo-700 bg-gradient-to-br from-indigo-50 to-indigo-100 dark:from-indigo-900/30 dark:to-indigo-800/30">
                <CardHeader className="border-b-2 border-indigo-200 dark:border-indigo-700">
                  <CardTitle className="text-indigo-700 dark:text-indigo-300">Weight Loss Insights & Tips</CardTitle>
                  <CardDescription>Personalized recommendations based on your data</CardDescription>
                </CardHeader>
                <CardContent className="pt-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-4">
                      <h3 className="font-semibold text-lg text-indigo-700 dark:text-indigo-300">Key Insights</h3>

                      {averageDailyCalories > nutritionGoals.calorieGoal && (
                        <div className="bg-red-50 dark:bg-red-900/30 border-2 border-red-200 dark:border-red-700 p-4 rounded-lg">
                          <h4 className="font-medium text-red-700 dark:text-red-300">Calorie Intake Too High</h4>
                          <p className="text-sm text-red-600 dark:text-red-400 mt-1">
                            You're consuming {averageDailyCalories - nutritionGoals.calorieGoal} calories above your
                            target. Consider reducing portion sizes or choosing lower-calorie alternatives.
                          </p>
                        </div>
                      )}
                      ...
                      {progress && progress.averagePerWeek > 2 && (
                        <div className="bg-yellow-50 dark:bg-yellow-900/30 border-2 border-yellow-200 dark:border-yellow-700 p-4 rounded-lg">
                          <h4 className="font-medium text-yellow-700 dark:text-yellow-300">Rapid Weight Loss</h4>
                          <p className="text-sm text-yellow-600 dark:text-yellow-400 mt-1">
                            You're losing weight faster than recommended. Consider increasing your calorie intake
                            slightly to ensure sustainable and healthy weight loss.
                          </p>
                        </div>
                      )}

                      {progress && progress.averagePerWeek < 0.5 && progress.daysTracked > 14 && (
                        <div className="bg-blue-50 dark:bg-blue-900/30 border-2 border-blue-200 dark:border-blue-700 p-4 rounded-lg">
                          <h4 className="font-medium text-blue-700 dark:text-blue-300">Slow Progress</h4>
                          <p className="text-sm text-blue-600 dark:text-blue-400 mt-1">
                            Your weight loss is slower than expected. Consider reducing your daily calorie intake by
                            100-200 calories or increasing your physical activity.
                          </p>
                        </div>
                      )}
                    </div>
                    ...
                    <div className="space-y-4">
                      <h3 className="font-semibold text-lg text-indigo-700 dark:text-indigo-300">Tips for Success</h3>

                      <div className="bg-white dark:bg-gray-800 border-2 border-indigo-300 dark:border-indigo-600 p-4 rounded-lg">
                        <h4 className="font-medium text-indigo-700 dark:text-indigo-300">Stay Consistent</h4>
                        <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">
                          Log your food and weight regularly. Consistency is key to successful weight loss.
                        </p>
                      </div>

                      <div className="bg-white dark:bg-gray-800 border-2 border-indigo-300 dark:border-indigo-600 p-4 rounded-lg">
                        <h4 className="font-medium text-indigo-700 dark:text-indigo-300">Focus on Protein</h4>
                        <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">
                          Aim for 0.8-1g of protein per pound of body weight to preserve muscle mass during weight loss.
                        </p>
                      </div>

                      <div className="bg-white dark:bg-gray-800 border-2 border-indigo-300 dark:border-indigo-600 p-4 rounded-lg">
                        <h4 className="font-medium text-indigo-700 dark:text-indigo-300">Stay Hydrated</h4>
                        <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">
