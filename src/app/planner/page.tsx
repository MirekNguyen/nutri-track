  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      <div className="flex flex-col md:flex-row flex-1">
        ...
        <main
          className={cn(
            "flex-1 p-4 md:p-6 overflow-auto max-w-[1400px] mx-auto",
        ...
        >
            ...
            {weekDays.map((day) => (
              <div key={day.toString()} className="w-full">
                <div className="text-center p-3 bg-white rounded-t-lg border border-gray-200 border-b-0 shadow-sm">
                  <p className="text-sm font-medium text-gray-500">{format(day, "EEEE")}</p>
                  <p
                ...
                <Card className="rounded-t-none shadow-sm">
                  <CardContent className="p-4 space-y-4">
                    {["breakfast", "lunch", "dinner", "snack"].map((mealTime) => (
                      <div key={mealTime} className="p-3 bg-gray-50 rounded-md hover:bg-gray-100 transition-colors">
                        <div className="flex items-center justify-between mb-2">
                          <p className="text-sm font-medium text-gray-700 capitalize">{mealTime}</p>
                          <Button
                            variant="outline"
                            size="sm"
                        ...
                        <div className="text-sm text-gray-500 italic">No meal planned</div>
                      </div>
                    ))}
                  </CardContent>
                </Card>
              ...
              <div key={day.toString()} className="flex flex-col min-h-[420px]">
                ...
                <Card className="rounded-t-none flex-1 shadow-sm">
                  <CardContent className="p-3 space-y-3">
                    {["breakfast", "lunch", "dinner", "snack"].map((mealTime) => (
                      <div key={mealTime} className="p-2.5 bg-gray-50 rounded-md hover:bg-gray-100 transition-colors">
                        <div className="flex items-center justify-between mb-1.5">
                          <p className="text-xs font-medium text-gray-700 capitalize">{mealTime}</p>
                          <Button
                            variant="ghost"
                            size="icon"
                            className="h-6 w-6"
                        ...
                        <div className="text-xs text-gray-500 italic">No meal planned</div>
                      </div>
                    ))}
                  </CardContent>
                </Card>
          ...
          <Card>
            ...
            <CardContent>
              <p className="text-gray-500">Your shopping list based on your meal plan will appear here.</p>
            </CardContent>
          </Card>
              ...
              <div className="grid gap-4 py-4">
                <div className="grid grid-cols-4 items-center gap-4">
                  ...
                  <Select>
                    ...
                    <SelectContent>
                      <SelectItem value="grilled-chicken">Grilled Chicken Salad</SelectItem>
                      <SelectItem value="protein-smoothie">Protein Smoothie Bowl</SelectItem>
                      <SelectItem value="salmon">Salmon with Roasted Vegetables</SelectItem>
                      <SelectItem value="avocado-toast">Avocado Toast with Eggs</SelectItem>
                    </SelectContent>
                  </Select>
                </div>
              </div>
              <DialogFooter>
                <Button className="bg-green-600 hover:bg-green-700">Add to Plan</Button>
              </DialogFooter>
            </DialogContent>
          </Dialog>
        </main>
