...
export const meals = pgTable("meals", {
  ...
  calories: numeric("calories", { precision: 10, scale: 2, mode: 'number' }).notNull(),
  protein: numeric("protein", { precision: 10, scale: 2, mode: 'number' }),
  carbs: numeric("carbs", { precision: 10, scale: 2, mode: 'number' }),
...
export const foodEntries = pgTable("food_entries", {
  ...
  amount: numeric("amount", { precision: 10, scale: 2, mode: 'number' }).default(1),
  calories: numeric("calories", { precision: 10, scale: 2, mode: 'number' }).notNull(),
