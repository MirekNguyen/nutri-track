...
export const MobileMenu = () => {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-50 flex h-20 w-full items-center justify-around bg-background/50 shadow-t dark:bg-background/50 backdrop-blur-3xl rounded-2xl dark:shadow-t-gray-800">
      {items.map((item) => (
        <Link
          href={item.url}
